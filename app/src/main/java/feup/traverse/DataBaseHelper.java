...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public static final String FLAG_SCORE_MUSIC = "score_audio";
    public static final String FLAG_SCORE_TEXT1 = "score_text1";
    public static final String FLAG_SCORE_MAPS = "score_maps";
    public static final String FLAG_SCORE_TEXT2 = "score_text2";
    public static final String FLAG_SCORE_SHARING = "score_sharing";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_NAME_CHAPTERS);
        onCreate(db);
    }
    ...
    public String scriptUserData (){
        ...
        userData_table.append(PROGRESS + " double not null, ");
    ...
    public String scriptChaptersData (){
        ...
        chapters_data_table.append(USERNAME + " varchar(20), ");
        chapters_data_table.append(CHAPTERNAME + " varchar(30) not null, ");
        chapters_data_table.append(CHAPTERNUMBER + " integer not null, ");
        chapters_data_table.append(FLAG_SCORE_MUSIC + " integer not null, ");
        chapters_data_table.append(FLAG_SCORE_TEXT1 + " integer not null, ");
        chapters_data_table.append(FLAG_SCORE_MAPS + " integer not null, ");
        chapters_data_table.append(FLAG_SCORE_TEXT2 + " integer not null, ");
        chapters_data_table.append(FLAG_SCORE_SHARING + " integer not null, ");
        chapters_data_table.append(SCORE + " integer not null ");
    ...
    public void initChaptersContent (SQLiteDatabase db){
        ...
        chapters_content[0] = "INSERT or replace INTO " + TABLE_NAME_CHAPTERS + " ( " + ID + ", " + CHAPTERNUMBER + ", " + CHAPTERNAME + ", " + FLAG_SCORE_MUSIC +
                ", " + FLAG_SCORE_TEXT1 + ", " + FLAG_SCORE_MAPS + ", " + FLAG_SCORE_TEXT2 + ", " + FLAG_SCORE_SHARING + "," + SCORE + " )" +
                " VALUES(1,1,'FUTURE IS CALLING',0,0,0,0,0,0)";
        chapters_content[1] = "INSERT or replace INTO " + TABLE_NAME_CHAPTERS + " ( " + ID + ", " + CHAPTERNUMBER + ", " + CHAPTERNAME + ", " + FLAG_SCORE_MUSIC +
                ", " + FLAG_SCORE_TEXT1 + ", " + FLAG_SCORE_MAPS + ", " + FLAG_SCORE_TEXT2 + ", " + FLAG_SCORE_SHARING + "," + SCORE + " )" +
                " VALUES(2,2,'MAD SCIENCE',0,0,0,0,0,0)";
        chapters_content[2] = "INSERT or replace INTO " + TABLE_NAME_CHAPTERS + " ( " + ID + ", " + CHAPTERNUMBER + ", " + CHAPTERNAME + ", " + FLAG_SCORE_MUSIC +
                ", " + FLAG_SCORE_TEXT1 + ", " + FLAG_SCORE_MAPS + ", " + FLAG_SCORE_TEXT2 + ", " + FLAG_SCORE_SHARING + "," + SCORE + " )" +
                " VALUES(3,3,'THROUGH TIME IN 80 SECONDS',0,0,0,0,0,0)";
        chapters_content[3] = "INSERT or replace INTO " + TABLE_NAME_CHAPTERS + " ( " + ID + ", " + CHAPTERNUMBER + ", " + CHAPTERNAME + ", " + FLAG_SCORE_MUSIC +
                ", " + FLAG_SCORE_TEXT1 + ", " + FLAG_SCORE_MAPS + ", " + FLAG_SCORE_TEXT2 + ", " + FLAG_SCORE_SHARING + "," + SCORE + " )" +
                " VALUES(4,4,'KEEP YOUR FRIENDS CLOSE...',0,0,0,0,0,0)";
        chapters_content[4] = "INSERT or replace INTO "+ TABLE_NAME_CHAPTERS + " ( " + ID + ", " + CHAPTERNUMBER + ", " + CHAPTERNAME + ", " + FLAG_SCORE_MUSIC +
                ", " + FLAG_SCORE_TEXT1 + ", " + FLAG_SCORE_MAPS + ", " + FLAG_SCORE_TEXT2 + ", " + FLAG_SCORE_SHARING + "," + SCORE + " )" +
                " VALUES(5,5,'THE ARTIFACT',0,0,0,0,0,0)";
        chapters_content[5] = "INSERT or replace INTO " + TABLE_NAME_CHAPTERS + " ( " + ID + ", " + CHAPTERNUMBER + ", " + CHAPTERNAME + ", " + FLAG_SCORE_MUSIC +
                ", " + FLAG_SCORE_TEXT1 + ", " + FLAG_SCORE_MAPS + ", " + FLAG_SCORE_TEXT2 + ", " + FLAG_SCORE_SHARING + "," + SCORE + " )" +
                " VALUES(6,6,'DIVIDE AND CONQUER',0,0,0,0,0,0)";
        chapters_content[6] = "INSERT or replace INTO "+ TABLE_NAME_CHAPTERS + " ( " + ID + ", " + CHAPTERNUMBER + ", " + CHAPTERNAME + ", " + FLAG_SCORE_MUSIC +
                ", " + FLAG_SCORE_TEXT1 + ", " + FLAG_SCORE_MAPS + ", " + FLAG_SCORE_TEXT2 + ", " + FLAG_SCORE_SHARING + "," + SCORE + " )" +
                " VALUES(7,7,'A NEW HOPE',0,0,0,0,0,0)";
        chapters_content[7] = "INSERT or replace INTO " + TABLE_NAME_CHAPTERS + " ( " + ID + ", " + CHAPTERNUMBER + ", " + CHAPTERNAME + ", " + FLAG_SCORE_MUSIC +
                ", " + FLAG_SCORE_TEXT1 + ", " + FLAG_SCORE_MAPS + ", " + FLAG_SCORE_TEXT2 + ", " + FLAG_SCORE_SHARING + "," + SCORE + " )" +
                " VALUES(8,8,'A FINAL TRIBULATION',0,0,0,0,0,0)";

...
public class ExternalDataBase extends AsyncTask<String,Void,String> {
    ...
    public void insertuser(String Table,String Operation, String Username, String Name, String Email, String Date, String Persona, int Status, double Progress, String Password)
